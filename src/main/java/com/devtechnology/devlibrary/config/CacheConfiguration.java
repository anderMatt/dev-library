package com.devtechnology.devlibrary.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("DevPresidentialLibrary");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("DevPresidentialLibrary");
        ...
        config.getMapConfigs().put("com.devtechnology.devlibrary.domain.*", initializeDomainMapConfig(jHipsterProperties));
